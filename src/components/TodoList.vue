...
<template>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-12">
        <div
            class="rounded-xl bg-slate-700 p-5 h-fit shadow-md shadow-slate-100/50"
            @drop="onDrop($event, 1)"
            @dragenter.prevent
            @dragover.prevent
            id="dropzone1"
        >
            <h2 class="flex text-slate-50 font-bold mb-4"><vue-feather type="list" stroke="white" class="mr-2"></vue-feather>To Do List</h2>
            <TodoItem
                :item="item"
                v-for="item in todos"
                :key="item.id"
        ...
        <div
            ...
            id="dropzone2"
        >
            <h2 class="flex text-slate-50 font-bold mb-4"><vue-feather type="chevrons-right" stroke="white" class="mr-2"></vue-feather>On Progress</h2>
            <TodoItem
                :item="item"
        ...
        <div
            ...
            id="dropzone3"
        >
            <h2 class="flex text-slate-50 font-bold mb-4"><vue-feather type="check" stroke="white" class="mr-2"></vue-feather>Finished</h2>
            <TodoItem
                :item="item"

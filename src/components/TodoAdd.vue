...
<template>
    <button
        ...
        v-if="!showFormAdd"
    >
        <vue-feather type="plus" size="18px" class="self-center mr-2"></vue-feather>
        Add Item
    </button>
    <div class="relative mt-5" v-if="showFormAdd">
        ...
        <div class="flex justify-end mt-2">
            ...
            <button
                class="bg-blue-700 hover:bg-blue-800 disabled:bg-blue-500 disabled:cursor-not-allowed text-white font-semibold rounded-lg px-4 py-2"
                @click="addItem(list)"
                :disabled="!title"
            >
                Add
